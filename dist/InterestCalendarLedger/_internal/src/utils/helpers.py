...
def load_custom_css():
    """Apply custom CSS styling to the Streamlit app with light theme."""
    st.markdown("""
    <style>
    ...
    /* Ensure dark mode styles are overridden */
    .st-bq, .st-co, .st-cp, .st-cq, .st-cr, .st-cs, .st-ct, .st-cu {
        background-color: #FFFFFF !important;
        color: #31333F !important;
    }
    
    /* Styled light theme base colors */
    :root {
        --bg-primary: #f8f9fb;
        --bg-secondary: #ffffff;
        --bg-tertiary: #f5f7fa;
        --accent-primary: #4b6bfb;
        --accent-secondary: #3a5ae8;
        --accent-tertiary: #7289fd;
        --text-primary: #2c3e50;
        --text-secondary: #485b73;
        --text-tertiary: #647b96;
        --border-color: #e0e6ef;
        --border-gradient-1: linear-gradient(to right, rgba(75,107,251,0.1), rgba(75,107,251,0.3), rgba(75,107,251,0.1));
        --border-gradient-2: linear-gradient(135deg, rgba(75,107,251,0.1), rgba(75,107,251,0.3), rgba(75,107,251,0.1));
        --border-gradient-blue: linear-gradient(to right, rgba(75,107,251,0.1), rgba(75,107,251,0.3), rgba(75,107,251,0.1));
        --shadow-color: rgba(58, 90, 232, 0.08);
    ...
    .dashboard-card:hover {
        ...
        box-shadow: 0 12px 20px rgba(58, 90, 232, 0.15);
        background-image: none;
    }
    ...
    section[data-testid="stSidebar"] {
        ...
        background-image: linear-gradient(135deg, rgba(75, 107, 251, 0.03) 25%, transparent 25%);
